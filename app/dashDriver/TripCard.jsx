    ...
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl transition-all">
      ...
      <div className="p-5">
        ...
        <div
          ...
          <div className="px-2 py-0 text-sm font-bold flex items-center justify-center text-sky-500 bg-white border border-gray-200 rounded-full hover:text-blue-700">
            Mon
          </div>
          <div className="px-2 py-0 text-sm font-bold flex items-center justify-center text-sky-500 bg-white border border-gray-200 rounded-full hover:text-blue-700">
            Tue
