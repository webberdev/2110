      ...
      <div className="p-5">
        ...
        <div className="flex flex-col gap-3">
          <a
            ...
            Confirm Pick Up &rarr;
          </a>
          <a
            href="/journey/end"
            className="inline-flex mx-2 items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 ">
            Emergency
          </a>
        </div>
      </div>
